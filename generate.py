      ...
      options: {{
        ...
        plugins: {{
          ...
          annotation: {{ annotations: {{
            ...
            t1start: {{
              type: 'line', scaleID: 'x',
              value: mLabels.findIndex(function(l) {{ return l.includes('Jan') && l.includes('2017'); }}),
              borderColor: 'rgba(0,0,0,0.1)', borderWidth: 1, borderDash: [2, 4],
              label: {{ content: 'Trump I', display: true, position: 'start',
                font: {{ size: 9, style: 'italic' }}, color: '#bbb',
                backgroundColor: 'transparent', padding: 2 }},
            }},
            bidenstart: {{
              type: 'line', scaleID: 'x',
              value: mLabels.findIndex(function(l) {{ return l.includes('Jan') && l.includes('2021'); }}),
              borderColor: 'rgba(0,0,0,0.1)', borderWidth: 1, borderDash: [2, 4],
              label: {{ content: 'Biden', display: true, position: 'start',
                font: {{ size: 9, style: 'italic' }}, color: '#bbb',
                backgroundColor: 'transparent', padding: 2 }},
            }},
            t2start: {{
              type: 'line', scaleID: 'x',
              value: mLabels.findIndex(function(l) {{ return l.includes('Jan') && l.includes('2025'); }}),
              borderColor: 'rgba(0,0,0,0.1)', borderWidth: 1, borderDash: [2, 4],
              label: {{ content: 'Trump II', display: true, position: 'start',
                font: {{ size: 9, style: 'italic' }}, color: '#bbb',
                backgroundColor: 'transparent', padding: 2 }},
            }},
          }} }},
