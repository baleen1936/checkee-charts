...
<style>
  * {{ box-sizing: border-box; margin: 0; padding: 0; }}
  ...
  h1 {{ text-align: center; font-size: 24px; font-weight: 700; padding: 24px 0 6px; letter-spacing: -0.3px; }}
  ...
  .filter-pill.active:hover {{ background: #0d47a1; }}
  ...
  .card h3 {{ text-align: center; font-size: 13px; font-weight: 600; margin-bottom: 8px; }}
